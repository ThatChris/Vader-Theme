...
// Adding Bigfootjs Footnotes
// Really wish these could work in RSS
function vader_add_bigfootscripts_yo() {
...
add_action( 'wp_enqueue_scripts', 'vader_add_bigfootscripts_yo' );

function vader_add_head() { ?>
    <!-- Your HTML goes here -->
    <script type="text/javascript">
    jQuery.bigfoot();
</script>
<?php }
add_action( 'wp_head', 'vader_add_head' );

// End Bigfootjs addition
